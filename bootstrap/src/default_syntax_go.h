static constexpr const char* DEFAULT_SYNTAX_GO =
    ...
    "supported_features = [\"nested-ifs\", \"bitmaps\", \"tags\", \"captures\", \"captvars\", \"vectorize-loops\"];\n"
    "\n"
    "\n"
    ...
    " \n"
    "code:vector_loop =\n"
    "    topindent \"for !(\" lessthan \") {\" nl\n"
    "        indent\n"
    "        topindent \"yysimd0 := archsimd.LoadUint8x\" size \"(\" YYINPUT \"[\" YYCURSOR \":])\" nl\n"
    "        [range{0}: topindent \"yysimd1 := yysimd0.GreaterEqual(archsimd.BroadcastUint8x\" size \"(\" range_lo \")).And(yysimd0.LessEqual(archsimd.BroadcastUint8x\" size \"(\" range_hi \")))\" nl]\n"
    "        [range{1:-1}: topindent \"yysimd1 = yysimd1.Or(yysimd0.GreaterEqual(archsimd.BroadcastUint8x\" size \"(\" range_lo \")).And(yysimd0.LessEqual(archsimd.BroadcastUint8x\" size \"(\" range_hi \"))))\" nl]\n"
    "        topindent \"if yysimd1.ToBits() != \" mask \" {\" nl\n"
