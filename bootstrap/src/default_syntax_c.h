static constexpr const char* DEFAULT_SYNTAX_C =
    ...
    "    \"tags\", \"captures\", \"captvars\", \"vectorize-loops\"];\n"
    "\n"
    "\n"
    ...
    "\n"
    "code:vector_loop =\n"
    "    topindent \"while (!(\" lessthan \")) {\" nl\n"
    "        indent\n"
    "        topindent \"__m256i yysimd0 = _mm256_loadu_si256((const __m256i*)(\" YYCURSOR \"));\" nl\n"
    "        [range{0}: topindent \"__m256i yysimd1 = _mm256_cmpeq_epi8(_mm256_or_si256(_mm256_subs_epu8(yysimd0, _mm256_set1_epi8(\" range_hi \")), _mm256_subs_epu8(_mm256_set1_epi8(\" range_lo \"), yysimd0)), _mm256_setzero_si256());\" nl]\n"
    "        [range{1:-1}: topindent \"yysimd1 = _mm256_or_si256(yysimd1, _mm256_cmpeq_epi8(_mm256_or_si256(_mm256_subs_epu8(yysimd0, _mm256_set1_epi8(\" range_hi \")), _mm256_subs_epu8(_mm256_set1_epi8(\" range_lo \"), yysimd0)), _mm256_setzero_si256()));\" nl]\n"
    "        topindent \"if ((unsigned int)_mm256_movemask_epi8(yysimd1) != \" mask \") {\" nl\n"
    "            indent topindent \"break;\" nl dedent\n"
    "        topindent \"}\" nl\n"
    "        topindent YYCURSOR \" += \" size \";\" nl\n"
    "        dedent\n"
    "    topindent \"}\" nl;\n"
    ;
